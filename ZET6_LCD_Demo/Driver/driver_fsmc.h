...
//#define LCD_BL(VALUE)               HAL_GPIO_WritePin(GPIOC, LCD_BL_PIN, VALUE?GPIO_PIN_SET:GPIO_PIN_RESET)
#define LCD_CS(VALUE)               HAL_GPIO_WritePin(GPIOG, LCD_CS_PIN, VALUE?GPIO_PIN_SET:GPIO_PIN_RESET)
#define LCD_RS(VALUE)               HAL_GPIO_WritePin(GPIOE, LCD_RS_PIN, VALUE?GPIO_PIN_SET:GPIO_PIN_RESET)
#define LCD_WR(VALUE)               HAL_GPIO_WritePin(GPIOD, LCD_WR_PIN, VALUE?GPIO_PIN_SET:GPIO_PIN_RESET)
#define LCD_RD(VALUE)               HAL_GPIO_WritePin(GPIOD, LCD_RD_PIN, VALUE?GPIO_PIN_SET:GPIO_PIN_RESET)
#define LCD_RST(VALUE)              HAL_GPIO_WritePin(GPIOF, LCD_RST_PIN, VALUE?GPIO_PIN_SET:GPIO_PIN_RESET)

/*
 *  函数名：void FSMC_LCD_Init(void)
 *  输入参数：无
 *  输出参数：无
 *  返回值：无
 *  函数作用：初始化连接LCD的FSMC
